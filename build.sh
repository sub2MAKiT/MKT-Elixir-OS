...
/usr/local/i386elfgcc/bin/i386-elf-gcc -ffreestanding -m32 -g -c "./src/renderBuffer/renderBuffer.c" -o "./unlinked/renderBuffer.o"
...
/usr/local/i386elfgcc/bin/i386-elf-ld -o "./unlinked/bin/fullKernel.bin" -Ttext 0x1000 "./unlinked/kernelEntry.o" "./unlinked/kernel.o" "./unlinked/renderBuffer.o" --oformat binary
